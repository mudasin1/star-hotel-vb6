---
title: System Initialization and Database Upgrade Flow
---
This document outlines how the hotel reservation system initializes at startup, ensuring the database is present, upgraded, and migrated as needed. The flow guides the system from initial checks through database preparation, ending with the login screen for user access.

```mermaid
flowchart TD
  node1["Bootstrapping and Database Upgrade Flow
Startup: Check for configuration and database files
(Bootstrapping and Database Upgrade Flow)"]:::HeadingStyle
  click node1 goToHeading "Bootstrapping and Database Upgrade Flow"
  node1 -->|"Missing files"| node2["Prompt user to configure database
(Bootstrapping and Database Upgrade Flow)"]:::HeadingStyle
  click node2 goToHeading "Bootstrapping and Database Upgrade Flow"
  node1 -->|"Files present"| node3["Connect and check database version
(Bootstrapping and Database Upgrade Flow)"]:::HeadingStyle
  click node3 goToHeading "Bootstrapping and Database Upgrade Flow"
  node3 -->|"Upgrade/migration needed"| node4["Upgrade and migrate database
(Bootstrapping and Database Upgrade Flow)"]:::HeadingStyle
  click node4 goToHeading "Bootstrapping and Database Upgrade Flow"
  node3 -->|"Up-to-date"| node5["Show login screen
(Bootstrapping and Database Upgrade Flow)"]:::HeadingStyle
  click node5 goToHeading "Bootstrapping and Database Upgrade Flow"
  node4 --> node5
classDef HeadingStyle fill:#777777,stroke:#333,stroke-width:2px;
```

# Bootstrapping and Database Upgrade Flow

```mermaid
%%{init: {"flowchart": {"defaultRenderer": "elk"}} }%%
flowchart TD
    node1["Begin system startup"] --> node2{"Is configuration file present?"}
    click node1 openCode "Form/frmSplash.frm:995:1021"
    node2 -->|"No"| node3["Prompt user to locate database"]
    click node2 openCode "Form/frmSplash.frm:1044:1052"
    node2 -->|"Yes"| node4{"Is database file present?"}
    click node3 openCode "Form/frmSplash.frm:1047:1051"
    node4 -->|"No"| node3
    click node4 openCode "Form/frmSplash.frm:1067:1076"
    node4 -->|"Yes"| node5{"Can connect to database?"}
    click node5 openCode "Form/frmSplash.frm:1080:1089"
    node5 -->|"No"| node6["Show error and exit"]
    click node6 openCode "Form/frmSplash.frm:1081:1088"
    node5 -->|"Yes"| node7{"Database version?"}
    click node7 openCode "Form/frmSplash.frm:1094:1137"
    node7 -->|1.2| node8["Upgrade database to 1.3"]
    click node8 openCode "Form/frmSplash.frm:1095:1107"
    node7 -->|1.1| node9["Migrate and upgrade database to 1.2"]
    click node9 openCode "Form/frmSplash.frm:1108:1126"
    node7 -->|"#lt;1.1"| node10["Upgrade database to 1.1"]
    click node10 openCode "Form/frmSplash.frm:1127:1133"
    node7 -->|"Up-to-date"| node12["Create reporting object"]
    click node12 openCode "Form/frmSplash.frm:1138:1142"
    node8 --> node12
    node9 --> node12
    node10 --> node12
    node12 --> node11["Show login screen"]
    click node11 openCode "Form/frmSplash.frm:1148:1150"
classDef HeadingStyle fill:#777777,stroke:#333,stroke-width:2px;
...
%% flowchart TD
%%     node1["Begin system startup"] --> node2{"Is configuration file present?"}
%%     click node1 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:995:1021"
%%     node2 -->|"No"| node3["Prompt user to locate database"]
%%     click node2 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:1044:1052"
%%     node2 -->|"Yes"| node4{"Is database file present?"}
%%     click node3 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:1047:1051"
%%     node4 -->|"No"| node3
%%     click node4 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:1067:1076"
%%     node4 -->|"Yes"| node5{"Can connect to database?"}
%%     click node5 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:1080:1089"
%%     node5 -->|"No"| node6["Show error and exit"]
%%     click node6 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:1081:1088"
%%     node5 -->|"Yes"| node7{"Database version?"}
%%     click node7 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:1094:1137"
%%     node7 -->|<SwmToken path="Form/frmSplash.frm" pos="250:11:13" line-data="    &#39;  Version 1.1 to 1.2">`1.2`</SwmToken>| node8["Upgrade database to <SwmToken path="Form/frmSplash.frm" pos="927:7:9" line-data="    If dblVersion = 1.3 Then">`1.3`</SwmToken>"]
%%     click node8 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:1095:1107"
%%     node7 -->|<SwmToken path="Form/frmSplash.frm" pos="250:5:7" line-data="    &#39;  Version 1.1 to 1.2">`1.1`</SwmToken>| node9["Migrate and upgrade database to <SwmToken path="Form/frmSplash.frm" pos="250:11:13" line-data="    &#39;  Version 1.1 to 1.2">`1.2`</SwmToken>"]
%%     click node9 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:1108:1126"
%%     node7 -->|"#lt;<SwmToken path="Form/frmSplash.frm" pos="250:5:7" line-data="    &#39;  Version 1.1 to 1.2">`1.1`</SwmToken>"| node10["Upgrade database to <SwmToken path="Form/frmSplash.frm" pos="250:5:7" line-data="    &#39;  Version 1.1 to 1.2">`1.1`</SwmToken>"]
%%     click node10 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:1127:1133"
%%     node7 -->|"Up-to-date"| node12["Create reporting object"]
%%     click node12 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:1138:1142"
%%     node8 --> node12
%%     node9 --> node12
%%     node10 --> node12
%%     node12 --> node11["Show login screen"]
%%     click node11 openCode "<SwmPath>[Form/frmSplash.frm](Form/frmSplash.frm)</SwmPath>:1148:1150"
%% classDef HeadingStyle fill:#777777,stroke:#333,stroke-width:2px;
```

<SwmSnippet path="/Form/frmSplash.frm" line="995">

---

In <SwmToken path="Form/frmSplash.frm" pos="995:4:4" line-data="Private Sub Timer1_Timer()">`Timer1_Timer`</SwmToken>, we start by checking for beta expiration (commented out), then set up the database path and filename if not already set. The function reads the config file if present, or prompts the user to configure the database if not. It checks for the existence of the database file and prompts again if missing. Once the database is found, it connects and checks the version. If an update is needed, it backs up the database and calls <SwmToken path="Form/frmSplash.frm" pos="1104:1:1" line-data="            Update_Database 1.3">`Update_Database`</SwmToken> to apply schema and data changes for compatibility.
...
<SwmSnippet path="/Form/frmSplash.frm" line="817">

---

<SwmToken path="Form/frmSplash.frm" pos="817:4:4" line-data="Private Sub Update_Database(dblVersion As Double)">`Update_Database`</SwmToken> applies schema and data changes based on the target version. For each version, it runs the necessary SQL to add columns, rename fields, insert missing reports, and update access permissions. It only applies changes relevant to the version passed in, then updates the version in the Company table.
...
<SwmSnippet path="/Form/frmSplash.frm" line="1110">

---

Back in <SwmToken path="Form/frmSplash.frm" pos="995:4:4" line-data="Private Sub Timer1_Timer()">`Timer1_Timer`</SwmToken>, after updating the database schema, we call <SwmToken path="Form/frmSplash.frm" pos="1110:1:1" line-data="            Migrate_Database">`Migrate_Database`</SwmToken> to handle any required data transformations and move records to fit the new structure. This step is necessary when the update alone isn't enough to bring legacy data in line with the new schema.
...
<SwmSnippet path="/Form/frmSplash.frm" line="240">

---

<SwmToken path="Form/frmSplash.frm" pos="240:4:4" line-data="Private Sub Migrate_Database()">`Migrate_Database`</SwmToken> loops through several tables, reading records from the old structure and updating the new one. It remaps fields, applies conditional logic (like <SwmToken path="Form/frmSplash.frm" pos="298:4:4" line-data="            SQL_SET_Text &quot;RoomStatus&quot;, &quot;Maintenance&quot;">`RoomStatus`</SwmToken> and <SwmToken path="Form/frmSplash.frm" pos="368:8:8" line-data="        Select Case rst(&quot;ModuleID&quot;).Value">`ModuleID`</SwmToken>), and handles missing values. After migrating, it alters <SwmToken path="Form/frmSplash.frm" pos="255:3:3" line-data="    &#39; UserData">`UserData`</SwmToken> to add a new column for the updated schema.
...
<SwmSnippet path="/Form/frmSplash.frm" line="1111">

---

After <SwmToken path="Form/frmSplash.frm" pos="240:4:4" line-data="Private Sub Migrate_Database()">`Migrate_Database`</SwmToken>, <SwmToken path="Form/frmSplash.frm" pos="995:4:4" line-data="Private Sub Timer1_Timer()">`Timer1_Timer`</SwmToken> backs up and replaces the database file, then calls <SwmToken path="Form/frmSplash.frm" pos="1124:1:1" line-data="            Update_Database 1.2">`Update_Database`</SwmToken> to finish applying required changes.
...
<SwmSnippet path="/Form/frmSplash.frm" line="1131">

---

Back in <SwmToken path="Form/frmSplash.frm" pos="995:4:4" line-data="Private Sub Timer1_Timer()">`Timer1_Timer`</SwmToken>, after all updates and migrations, we create the reporting object, hide the splash screen, show the login form, and unload the splash. This wraps up the initialization and hands control to the user.
